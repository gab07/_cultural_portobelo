...
class OrderItemsControllerTest < ActionController::TestCase
  ...
  test "should create order_item" do
    assert_difference('OrderItem.count') do
      post :create, order_item: { create: @order_item.create, destroy: @order_item.destroy, update: @order_item.update }
    end
  ...
  test "should update order_item" do
    patch :update, id: @order_item, order_item: { create: @order_item.create, destroy: @order_item.destroy, update: @order_item.update }
    assert_redirected_to order_item_path(assigns(:order_item))
  end
